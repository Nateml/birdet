...
<aside class="flex h-dvh w-56 shrink-0 flex-col border-r border-be-border bg-be-card">
	...
	<div class="flex items-center justify-between px-5 py-4">
		<p class="font-be-mono text-[10px] text-be-muted-fg">alpha</p>
		<button
			onclick={toggleTheme}
			class="flex h-7 w-7 items-center justify-center rounded-lg border border-be-border text-be-muted-fg transition-colors hover:bg-be-secondary/50 hover:text-be-fg"
